 ...
 * Version:
 */
public class FacePreviewView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public FacePreviewView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTipTextSize = array.getDimensionPixelSize(R.styleable.FaceView_tip_text_size, 12);
        array.recycle();
        LogUtils.i("FaceView构造");
        initHolder(context);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogUtils.i("onMeasure  mViewWidth : " + mViewWidth + "  mViewHeight : " + mViewHeight);
        ...
        mSweepGradient = new SweepGradient(mCenterPoint.x - mStartAngle, mCenterPoint.y - mStartAngle, getResources().getColor(R.color.colorPrimaryDark), getResources().getColor(R.color.colorPrimaryDark));
    }
