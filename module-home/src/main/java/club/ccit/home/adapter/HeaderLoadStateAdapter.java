 ...
 * Version:
 */
public class HeaderLoadStateAdapter extends androidx.paging.LoadStateAdapter<HeaderLoadStateAdapter.ViewHolder> {
    private View.OnClickListener mRetryCallback;

    public HeaderLoadStateAdapter(View.OnClickListener mRetryCallback) {
