...
import club.ccit.widget.DatePickerView;
 ...
 *
 * @author: 张帅威
 * Date: 2022/2/10 8:35 上午
 * Description: 日期选择器弹窗
 * Version:
 */
public class DatePickerDialog implements View.OnClickListener, DatePickerView.OnSelectListener {
    ...
    private DatePickerView mDpvYear, mDpvMonth, mDpvDay, mDpvHour, mDpvMinute;
     ...
     */
    public DatePickerDialog(Context context, Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
    public DatePickerDialog(Context context, Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        if (window != null) {
            ...
            lp.width = (int) (getScreenWidth(mContext) * 0.95);
