package club.ccit.widget.dialog.city.citywhee;
...
import club.ccit.widget.dialog.city.Utils;
...
/**
 * FileName: CityParseHelper
 *
 * @author: 张帅威
 * Date: 2022/3/1 8:43 上午
 * Description:
 * Version:
 */
public class CityParseHelper {
    ...
    public void initData(Context context) {
        ...
        String cityJson = Utils.getJson(context, CityConfig.CITY_DATA);
