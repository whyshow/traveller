...
import club.ccit.widget.banner.layoutmanager.BannerLayoutManager;
import club.ccit.widget.banner.layoutmanager.CenterSnapHelper;

/**
 * FileName: BannerLayout
 *
 * @author: 张帅威
 * Date: 2022/1/24 9:48 上午
 * Description:
 * Version:
 */
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        centerScale = a.getFloat(R.styleable.BannerLayout_centerScale, 1.5f);
