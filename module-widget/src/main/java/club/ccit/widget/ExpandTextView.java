...
/**
 * FileName: ExpandTextView
 *
 * @author: 张帅威
 * Date: 2022/3/29 10:50
 * Description: 有展开收起的TextView
 * Version:
 */
public class ExpandTextView  extends RelativeLayout implements View.OnClickListener {
     ...
     * 展开/收起文字颜色
     */
    private int mExpandTextColor = Color.parseColor("#4AA736");
    ...
    private void initAttributeSet(Context context, AttributeSet attrs){
        ...
        if (ta != null) {
            ...
            mContentTextSize = ta.getDimensionPixelSize(R.styleable.ExpandTextView_contentTextSize, sp2px(context, 18));
            mContentTextColor = ta.getColor(R.styleable.ExpandTextView_contentTextColor, 0);
            mExpandTextSize = ta.getDimensionPixelSize(R.styleable.ExpandTextView_expandTextSize, sp2px(context, 18));
            ...
            mSpaceMargin = ta.getDimensionPixelSize(R.styleable.ExpandTextView_spaceMargin, dp2px(context, 20));
    ...
    private void handleEllipsizeString(StaticLayout staticLayout, int lineWidth) {
        ...
        float reservedWidth = mSpaceMargin + textPaint.measureText(strEllipsizeMark) + getExpandTextViewReservedWidth();
